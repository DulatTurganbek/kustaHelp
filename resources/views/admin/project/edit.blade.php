                        ...
                        <div class="card-body">
                            <form action="{{ route('project.update', $project['id']) }}" method="POST">
                                    ...
                                    <div class="tab-pane show active">
                                        <div class="row">
                                            <div class="form-group col-xs-12 col-sm-12 col-md-12 ">
                                                ...
                                                <input class="form-control " placeholder="Введите заголовок"name="title" type="text" value="{{ $project['title'] }}">
                                            </div>
                                            <div class="form-group col-xs-12 col-sm-12 col-md-12 ">
                                                <label for="description[ru]">Описание</label>
                                                <span class="text-danger">*</span>
                                                <textarea class="form-control " placeholder="Введите описание" rows="5" name="description" cols="50">{{ $project['description'] }}</textarea>
                                            </div>
                                            <div class="form-group col-xs-12 col-sm-12 col-md-12 ">
                                                <label for="content[ru]">Содержание </label>
                                                <span class="text-danger">*</span>
                                                <textarea class="editor" placeholder="Введите содержание" rows="5" name="content" > {{ $project['content'] }} </textarea>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group col-xs-12 col-sm-12 col-md-12 ">
                                    <label>Слаг</label>
                                    <span class="text-danger">*</span>
                                    <input class="form-control " placeholder="Введите slug" name="slug" type="text" value="{{$project['slug']}}">
                                </div>
